...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/10/03 15:34:43 by kboulkri          #+#    #+#             */
/*   Updated: 2023/11/07 17:36:33 by kboulkri         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_sort_b_till_3(t_stack **stack_a, t_stack **stack_b)
{
	...
	while (lst_size(*stack_a) > 3 && !ft_checksorted(*stack_a))
	{
		tmp = *stack_a;
...
t_stack	*ft_sort_b(t_stack **stack_a)
{
	...
	stack_b = NULL;
	if (lst_size(*stack_a) > 3 && !ft_checksorted(*stack_a))
